    ...
    <div class="container mx-auto px-6 py-8">
        <div class="relative text-center py-20 bg-gray-800 rounded-lg shadow-xl mb-12 overflow-hidden">
            <div class="absolute inset-0">
                <img src="https://images.unsplash.com/photo-1580582932707-520aed93a94d?q=80&w=1932&auto=format&fit=crop"
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div
                class="bg-gray-800 rounded-lg shadow-lg p-6 text-center transform hover:scale-105 transition-transform duration-300">
                ...
                <a href="{{ route('students.index') }}"
                    class="inline-block bg-sky-600 text-white px-6 py-2 rounded-full hover:bg-sky-700">Lihat Detail</a>
            </div>
            <div
                class="bg-gray-800 rounded-lg shadow-lg p-6 text-center transform hover:scale-105 transition-transform duration-300">
